            ...
            <React.Fragment>
                <Helmet>
                    ...
                    {(style === 'bold') ? (
                      ...
                      (font === 'serif') ? (
                      @import url(//db.onlinewebfonts.com/c/e4882e9d8090461fea09938d738a3361?family=Cooper+BT); //<link href="https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400;0,700;1,400;1,700&display=swap" rel="stylesheet"/>
                      ) : 
