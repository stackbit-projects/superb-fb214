            ...
            <React.Fragment>
                <Helmet>
                    ...
                    {(style === 'bold') ? (
                      ...
                      <link href="//db.onlinewebfonts.com/c/9d4d074c9335825a23cce178ee03b498?family=P22MackinacW01-Book" rel="stylesheet" type="text/css"/> //<link href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,400;0,700;1,400;1,700&display=swap" rel="stylesheet"/>
                    ) : 
                      (font === 'serif') ? (
